#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Standalone ZZ500/HS300 ADK spread substrategy.

This module exposes the purple-column finalized sleeve as an importable
sub-strategy while keeping exact parity with the fixed final runner.
"""
...
import final_adk_zz500_hs300_spread as final_strategy
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run finalized standalone ZZ500/HS300 ADK spread purple-column substrategy.",
    )
    parser.add_argument(
        "--profile",
        choices=sorted(final_strategy.PROFILES),
        default=DEFAULT_PROFILE,
        help="Final fixed profile to run; default is the purple-column main_confirm profile.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
