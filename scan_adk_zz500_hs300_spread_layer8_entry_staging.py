"""Layer 8 first-entry staging diagnostic for long ZZ500 / short HS300.
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_hs300_spread_long_only_v77_adk_spread_layer8_entry_staging_close_proxy_after_l7_volhot"
...
def state_overlap_summary(daily_all: pd.DataFrame) -> pd.DataFrame:
    ...
    for candidate, d in daily_all.groupby("candidate"):
        ...
        masks = {
            "volhot0_stage0": ~overlay_on & ~stage_on,
            "volhot1_stage0": overlay_on & ~stage_on,
            "volhot0_stage1": ~overlay_on & stage_on,
            "volhot1_stage1": overlay_on & stage_on,
        }
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/HS300 Layer 8 First-Entry Staging Close Proxy",
        "",
        "## Run Metadata",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/HS300 spread Layer 8 entry staging",
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "\n".join(
            [
                'python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project "A-share / US momentum combo" --strategy "V7.7 ADK spread research" --subsystem "ZZ500/HS300 spread Layer 8 entry staging" --parameter-group "first_entry_staging_close_proxy_after_l7_volhot" --repo . --entrypoint "scan_adk_zz500_hs300_spread_layer8_entry_staging.py" --date 2026-06-12 --slug "adk_zz500_hs300_spread_long_only_v77_adk_spread_layer8_entry_staging_close_proxy_after_l7_volhot"',
                'python -m py_compile "scan_adk_zz500_hs300_spread_layer8_entry_staging.py"',
                'git diff --check -- "scan_adk_zz500_hs300_spread_layer8_entry_staging.py"',
                'python "scan_adk_zz500_hs300_spread_layer8_entry_staging.py"',
