"""Layer 5 three-overheat scan after NAV defense for SZ50/CYB.
...
Amount/volume is intentionally not included here because no SZ50/CYB amount panel
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260609_adk_sz50_cyb_reverse_spread_long_only_v77_adk_reverse_spread_layer5_overheat_after_nav_with_return_line"
...
def main() -> None:
    ...
    record_lines = [
        "# SZ50/CYB Layer 5 Overheat After NAV",
        "",
        "## Run Metadata",
        ...
        "- Amount/volume overheat excluded because no fresh SZ50/CYB amount panel was built in this run.",
        ...
        "",
        "## Commands",
        "- `python -m py_compile \"scan_adk_sz50_cyb_reverse_spread_layer5_overheat_after_nav.py\"`",
        "- `python \"scan_adk_sz50_cyb_reverse_spread_layer5_overheat_after_nav.py\"`",
