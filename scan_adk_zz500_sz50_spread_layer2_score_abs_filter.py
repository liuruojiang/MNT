"""Layer 2 score and absolute-bias filter scan for long ZZ500 / short SZ50.

Inputs are the Layer 1 width-supported carry candidates. This layer scans score
thresholds and an absolute ZZ500/SZ50 ratio-bias gate only. Target-vol, NAV
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_sz50_spread_long_only_v77_adk_spread_layer2_score_abs_filter_four_l1_width_anchors"

ANCHORS = [
    {
        "anchor": "bias_115_20_we2p5",
        "family": "bias_momentum",
        "bias_ma": 115,
        "mom_day": 20,
        "weight_end": 2.5,
        "layer1_candidate": "dense_bias_ma115_mom020_we2p5_gt0",
    },
    {
        "anchor": "bias_110_22_we2p25",
        "family": "bias_momentum",
        "bias_ma": 110,
        "mom_day": 22,
        "weight_end": 2.25,
        "layer1_candidate": "dense_bias_ma110_mom022_we2p25_gt0",
    },
    {
        "anchor": "bias_115_22_we2p75",
        "family": "bias_momentum",
        "bias_ma": 115,
        "mom_day": 22,
        "weight_end": 2.75,
        "layer1_candidate": "dense_bias_ma115_mom022_we2p75_gt0",
    },
    {
        "anchor": "log_15_we2",
        ...
        "mom_day": 15,
        "weight_end": 2.0,
        "layer1_candidate": "dense_log_wls_mom015_we2p0_gt0",
    },
]
...
def select_carry(window_metrics: pd.DataFrame, ridge: pd.DataFrame) -> pd.DataFrame:
    ...
    if patch.empty:
        pool = window_metrics[
            ...
            & (window_metrics["pass_loss_le_2p0pp"])
        ].copy()
    else:
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/SZ50 Layer 2 Score And Absolute-Bias Filter Scan",
        "",
        "## Run Metadata",
        ...
        "",
        "## Research Question",
        "Scan score thresholds and absolute ratio-bias filters against the four Layer 1 width-supported anchors.",
        "",
        "## Layer Inputs",
        "- Anchors:",
        *[
        ...
        "- Imports data loader and metrics from `scan_adk_zz500_sz50_spread_long_only.py`.",
        "- Uses vectorized weighted-slope/R2 from `scan_adk_zz500_sz50_spread_layer1_dense_patch.py`.",
        ...
        "",
        "## Commands",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"ZZ500/SZ50 spread Layer 2 score abs\" --parameter-group \"score_threshold_abs_bias_filter\" --repo . --entrypoint \"scan_adk_zz500_sz50_spread_layer2_score_abs_filter.py\" --date 2026-06-12 --slug \"adk_zz500_sz50_spread_long_only_v77_adk_spread_layer2_score_abs_filter_four_l1_width_anchors\"`",
        "- `python -m py_compile \"scan_adk_zz500_sz50_spread_layer2_score_abs_filter.py\"`",
        "- `python \"scan_adk_zz500_sz50_spread_layer2_score_abs_filter.py\"`",
