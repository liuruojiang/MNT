"""Layer 4 NAV drawdown defense for long ZZ500 / short CYB.
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_cyb_spread_long_only_v77_adk_spread_layer4_nav_defense_l3_bias_carry"

L3_INPUTS = [
    {
        "layer3_anchor": "confirm_tv10_rv20_max1p25_floor0p5_abs15",
        "layer2_anchor": "bias_confirm_abs65_m3",
        "anchor": "bias_10_29_we3",
        "layer2_role": "nearby_confirmation",
        "role": "best_layer3_carry",
        ...
        "deadband_mode": "abs",
        "deadband_value": 0.15,
        "source_candidate": "l3_bias_confirm_abs65_m3_tv10_rv20_max1p25_floor0p5_dbabs0p15",
    },
    {
        "layer3_anchor": "confirm_tv12_rv20_max1_floor0_rel5",
        "layer2_anchor": "bias_confirm_abs65_m3",
        "anchor": "bias_10_29_we3",
        "layer2_role": "nearby_confirmation",
        "role": "strict_full_5y_dd_line",
        "family": "bias_momentum",
        "bias_ma": 10,
        "mom_day": 29,
        "weight_end": 3.0,
    ...
    {
        "layer3_anchor": "primary_tv10_rv20_max1p25_floor0p5_abs15",
        "layer2_anchor": "bias_primary_abs60_m2p5",
        "anchor": "bias_10_29_we3",
        "layer2_role": "primary_bias",
        "role": "primary_bias",
        "family": "bias_momentum",
        "bias_ma": 10,
        "mom_day": 29,
        ...
        "deadband_mode": "abs",
        "deadband_value": 0.15,
        "source_candidate": "l3_bias_primary_abs60_m2p5_tv10_rv20_max1p25_floor0p5_dbabs0p15",
    },
    {
        "layer3_anchor": "ddtight_tv15_rv20_max1p25_floor0p5_abs05",
        "layer2_anchor": "bias_dd_tight_score1_abs35_p3p5",
        "anchor": "bias_10_29_we3",
        "layer2_role": "dd_tight_watchlist",
        ...
        "deadband_mode": "abs",
        "deadband_value": 0.05,
        "source_candidate": "l3_bias_dd_tight_score1_abs35_p3p5_tv15_rv20_max1p25_floor0p5_dbabs0p05",
    },
]
...
def window_table(df: pd.DataFrame, n: int = 10) -> str:
    ...
    display["nav_dd_threshold"] = display["nav_dd_threshold"].map(lambda x: pct(float(x)) if pd.notna(x) else "")
    display["defense_day_ratio_full"] = display["defense_day_ratio_full"].map(
        lambda x: pct(float(x)) if pd.notna(x) else ""
    )
    for segment, _years in base.SEGMENTS:
        cell_col = f"{segment}_ann_dd_delta"
        display[cell_col] = df.head(n).apply(
            lambda row: (
                f"{pct(float(row[f'ann_return_{segment}']))}/{pct(float(row[f'max_dd_{segment}']))} "
                f"(dAnn {float(row[f'{segment}_ann_loss_pp']) * -1:.2f}pp, "
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/CYB Layer 4 NAV Defense Scan",
        "",
        "## Run Metadata",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/CYB spread Layer 4 NAV defense",
        "repo_root": str(base.ROOT),
        "entrypoint": str(Path(__file__).name),
        "implementation_anchor": "scan_adk_zz500_cyb_spread_layer3_target_vol.py",
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"ZZ500/CYB spread Layer 4 NAV defense\" --parameter-group \"nav_drawdown_threshold_defense_scale\" --repo . --entrypoint \"scan_adk_zz500_cyb_spread_layer4_nav_defense.py\" --date 2026-06-12 --slug \"adk_zz500_cyb_spread_long_only_v77_adk_spread_layer4_nav_defense_l3_bias_carry\"\n"
        "python -m py_compile \"scan_adk_zz500_cyb_spread_layer4_nav_defense.py\"\n"
        "python \"scan_adk_zz500_cyb_spread_layer4_nav_defense.py\"\n"
