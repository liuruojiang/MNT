...
HELPER_PATH = (
    ...
    / "20260512_v76_five_sleeve_v20_rebalance_validation"
    / "run_five_sleeve_v20_rebalance_validation.py"
)
...
def write_record(wm: pd.DataFrame, weights: pd.DataFrame, data_meta: dict[str, object]) -> None:
    ...
    text = f"""# V7.6 Five-Sleeve Real Sub-D V2.0 Validation
...
def main() -> None:
    ...
    meta = {
        "phase": "scanned",
        "scan_type": "v76_five_sleeve_real_subd_v20_rebalance_validation",
    ...
    with (RUN_DIR / "command_log.txt").open("a", encoding="utf-8") as f:
        f.write("python quant_param_scan_runs\\20260512_v76_five_sleeve_real_subd_v20_rebalance_validation\\run_real_subd_v20_rebalance_validation.py\n")
