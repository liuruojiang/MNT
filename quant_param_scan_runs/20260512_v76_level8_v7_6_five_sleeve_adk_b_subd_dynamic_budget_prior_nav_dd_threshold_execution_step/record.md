# V7.6 ADK/B/Sub-D Dynamic Budget Optimization
...
Microcap's `3/10` dynamic budget rule should not be assumed to fit ADK, Sub-B, or Sub-D. This scan tests each sleeve against its own prior NAV drawdown state.
...
- `C:/Users/Administrator.DESKTOP-95I7VVU/Desktop/动量策略/A股美股动量组合策略/quant_param_scan_runs/20260512_v76_level8_v7_6_five_sleeve_adk_b_subd_dynamic_budget_prior_nav_dd_threshold_execution_step/scan_summary.csv`
- `C:/Users/Administrator.DESKTOP-95I7VVU/Desktop/动量策略/A股美股动量组合策略/quant_param_scan_runs/20260512_v76_level8_v7_6_five_sleeve_adk_b_subd_dynamic_budget_prior_nav_dd_threshold_execution_step/window_metrics.csv`
- `C:/Users/Administrator.DESKTOP-95I7VVU/Desktop/动量策略/A股美股动量组合策略/quant_param_scan_runs/20260512_v76_level8_v7_6_five_sleeve_adk_b_subd_dynamic_budget_prior_nav_dd_threshold_execution_step/scan_meta.json`
...
- Sleeves tested: Sub-A-DK, Sub-B, Sub-D.
- ADK and Sub-D use Sub-B as absorber.
...
Use this run as candidate-selection evidence only. Do not promote ADK, Sub-B, or Sub-D dynamic budget rules without a follow-up stability read against the chosen candidate's role and live display complexity.

## User-Facing Summary

Microcap's 3/10 rule is a valid framework seed, but ADK, Sub-B, and Sub-D require sleeve-specific parameters. In this run, Sub-D is the strongest follow-up candidate, Sub-B is weak under this design, and ADK is only narrow-positive.
## Finalization

- Finalized at: 2026-05-12T14:05:04+08:00
- Decision: ADK/B/Sub-D require sleeve-specific dynamic-budget tests. Current evidence: Sub-D has the strongest follow-up candidate, Sub-B dynamic budget is weak under this proportional-absorber design, ADK is narrow-positive but not broad enough for default promotion.
- Stability label: candidate evidence; requires follow-up stability validation
