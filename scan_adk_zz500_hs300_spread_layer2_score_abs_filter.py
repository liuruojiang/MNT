"""Layer 2 score and absolute-bias filter scan for long ZZ500 / short HS300.

Inputs are the Layer 1 dense width-supported carry candidates. This layer scans
score thresholds and an absolute ZZ500/HS300 ratio-bias gate only. Target-vol,
...
import scan_adk_zz500_hs300_spread_layer1_dense_patch as l1dense
import scan_adk_zz500_hs300_spread_long_only as base


RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_hs300_spread_long_only_v77_adk_spread_layer2_score_abs_filter_four_l1_width_anchors"
...
ANCHORS = [
    {
        ...
        "mom_day": 19,
        "weight_end": 3.0,
        "layer1_candidate": "dense_log_wls_mom019_we3p0_gt0",
    },
    {
        "anchor": "log_19_we2p5",
        "family": "log_wls_momentum",
        ...
        "mom_day": 19,
        "weight_end": 2.5,
        "layer1_candidate": "dense_log_wls_mom019_we2p5_gt0",
    },
    {
        "anchor": "bias_130_20_we1p5",
        "family": "bias_momentum",
        "bias_ma": 130,
        "mom_day": 20,
        "weight_end": 1.5,
        "layer1_candidate": "dense_bias_ma130_mom020_we1p5_gt0",
    },
    {
        ...
        "mom_day": 20,
        "weight_end": 2.0,
        "layer1_candidate": "dense_bias_ma130_mom020_we2p0_gt0",
    },
]
...
def load_panel() -> tuple[object, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    panel["spread_return"] = panel["ZZ500"].pct_change().fillna(0.0) - panel["HS300"].pct_change().fillna(0.0)
    return mod, zz500, hs300, panel
...
def main() -> None:
    ...
    mod, zz500, hs300, panel = load_panel()
    ...
    record_lines = [
        "# ZZ500/HS300 Layer 2 Score And Absolute-Bias Filter Scan",
        "",
        "## Run Metadata",
        ...
        *[
        ...
        "- Imports data loader and metrics from `scan_adk_zz500_hs300_spread_long_only.py`.",
        "- Uses vectorized weighted-slope/R2 from `scan_adk_zz500_hs300_spread_layer1_dense_patch.py`.",
        ...
        "",
        "## Commands",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"ZZ500/HS300 spread Layer 2 score abs\" --parameter-group \"score_threshold_abs_bias_filter\" --repo . --entrypoint \"scan_adk_zz500_hs300_spread_layer2_score_abs_filter.py\" --date 2026-06-12 --slug \"adk_zz500_hs300_spread_long_only_v77_adk_spread_layer2_score_abs_filter_four_l1_width_anchors\"`",
        "- `python -m py_compile \"scan_adk_zz500_hs300_spread_layer2_score_abs_filter.py\"`",
        "- `python \"scan_adk_zz500_hs300_spread_layer2_score_abs_filter.py\"`",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/HS300 spread Layer 2 score abs",
