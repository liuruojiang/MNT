"""Layer 9 amount filter for long ZZ500 / short CYB.
...
import scan_adk_zz500_cyb_spread_layer8_entry_staging as l8
import scan_adk_zz500_cyb_spread_long_only as base


RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_cyb_spread_long_only_v77_adk_spread_layer9_amount_after_l7_volhot"
...
def layer7_base_returns(
    ...
    return l8.layer7_base_returns(panel, line, scores, r2s, abs_bias)
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/CYB Layer 9 Amount Filter",
        "",
        "## Run Metadata",
        ...
        "- Amount features use own-MA relative values or pair-relative ratios; pair amount is ZZ500 relative amount / CYB relative amount.",
        "- Entry staging is off; Layer 5 momentum decay and Layer 7 volhot remain active as the baseline.",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/CYB spread Layer 9 amount",
        "repo_root": str(base.ROOT),
        "entrypoint": str(Path(__file__).name),
        "implementation_anchor": "scan_adk_zz500_cyb_spread_layer8_entry_staging.py",
        ...
        "data_snapshot": {
            ...
            "pair_amount_feature": "ZZ500 amount relative-to-MA / CYB amount relative-to-MA",
        },
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "\n".join(
            [
                'python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project "A-share / US momentum combo" --strategy "V7.7 ADK spread research" --subsystem "ZZ500/CYB spread Layer 9 amount" --parameter-group "amount_relative_ma_filter_after_layer7_volhot" --repo . --entrypoint "scan_adk_zz500_cyb_spread_layer9_amount.py" --date 2026-06-12 --slug "adk_zz500_cyb_spread_long_only_v77_adk_spread_layer9_amount_after_l7_volhot"',
                'python -m py_compile "scan_adk_zz500_cyb_spread_layer9_amount.py"',
                'git diff --check -- "scan_adk_zz500_cyb_spread_layer9_amount.py"',
                'python "scan_adk_zz500_cyb_spread_layer9_amount.py"',
