...
poe.update_settings(SettingsResponse(
    introduction_message=(
        ...
        "**📊 仓位管理:** \"设置仓位 Sub-B: VOO 100股 QQQM 50股\"\n"
    ),
))
    ...
    def run(self):
        ...
        if "实盘表现" in query:
            ...
            with _sm() as msg:
                ...
                msg.write("- **设置仓位 Sub-B: VOO 100股 QQQM 50股**\n")
...
规则:
1. skip=没跟信号 2. Sub-A标的:ZZHL-ETF/CYB-ETF/HS300/ZZ1000/ZZ500/Cash
3. Sub-B/C用大写ETF代码 4. Sub-A-DK: "做多中证1000"或"做多上证50"
5. exec_prices:价格,没有写{{}} 6. quantities:数量(整数),50手=5000,没有写{{}}
7. weights:仅多标的时填 8. commission:手续费5块->amount:5,千一->rate:0.001,没提->null
9. signal_followed:true/false/null 10. trade_date:今天={today},没说=null
11. from_holding:根据描述或记录推断,不确定=null"""
