...
CN_DK_USE_R2_FILTER = False  # False=仅展示,不参与交易; True=R²<阈值时清仓
        ...
        with _sm() as msg:
            ...
            if _r2_val_rt is not None:
                if _r2_low_rt:
                    ...
                    _r2_action_rt = "建议观望" if not CN_DK_USE_R2_FILTER else "→ 清仓"
        ...
        with _sm() as msg:
            ...
            if _r2_val_p is not None:
                if _r2_low_p:
                    ...
                    _r2_action_p = "建议观望" if not CN_DK_USE_R2_FILTER else "→ 清仓"
            ...
            if PROD_VS_ENABLED:
                w(f"\n**Vol-Scaling:** 目标波动率{PROD_VS_TARGET_VOL:.0%} | "
                  f"窗口{PROD_VS_VOL_WINDOW}d | 杠杆[{PROD_VS_MIN_LEV:.1f}x, {PROD_VS_MAX_LEV:.1f}x] | "
                  f"阈值Δ≥{PROD_VS_THRESHOLD:.0%}\n")
