...
class CombinedStrategyV3:
    ...
    def _run_strategies(self, cn_close, us_rot_close, us_prod_daily):
        ...
        prod_nav, prod_details = simulate_prod(
            PROD_PORTFOLIO, prod_monthly_ret, prod_sig_a, cash_ret, PROD_REBAL_MONTH,
    ...
    def _handle_performance(self, query):
        ...
        subc_daily = _compute_daily_subc(us_prod_daily, prod_sig_a, PROD_PORTFOLIO, PROD_CASH,
