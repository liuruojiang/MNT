"""Layer 8 first-entry staging diagnostic for long ZZ500 / short CYB.
...
import scan_adk_zz500_cyb_spread_layer7_overheat as l7
import scan_adk_zz500_cyb_spread_long_only as base


RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_cyb_spread_long_only_v77_adk_spread_layer8_entry_staging_close_proxy_after_l7_volhot"
...
LINES = [
    {
        **l7.LINES[0],
        ...
        "layer7_candidate": "l7_confirm_strict_small_decay_volhot_w20_thr15_scale0p25",
        "overlay_kind": "volhot",
        "param_a": 20.0,
        "param_b": 0.15,
        "param_c": 0.25,
    },
    {
        **l7.LINES[1],
        ...
        "layer7_candidate": "l7_confirm_strict_defensive_decay_volhot_w30_thr15_scale0",
        "overlay_kind": "volhot",
        "param_a": 30.0,
        "param_b": 0.15,
        "param_c": 0.00,
    },
    {
        **l7.LINES[2],
        ...
        "layer7_candidate": "l7_confirm_carry_dd_decay_volhot_w60_thr22_scale0",
        "overlay_kind": "volhot",
        "param_a": 60.0,
        "param_b": 0.22,
        "param_c": 0.00,
    },
    {
        **l7.LINES[3],
        ...
        "layer7_candidate": "l7_primary_bias_dd_decay_volhot_w20_thr15_scale0",
        "overlay_kind": "volhot",
        "param_a": 20.0,
        "param_b": 0.15,
        "param_c": 0.00,
...
def layer7_base_returns(
    ...
    l4_frame = l7.decay_base_frame(panel, line, scores, r2s, abs_bias)
    d = l7.apply_overlay(
        l4_frame,
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/CYB Layer 8 First-Entry Staging Close Proxy",
        "",
        "## Run Metadata",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/CYB spread Layer 8 entry staging",
        "repo_root": str(base.ROOT),
        "entrypoint": str(Path(__file__).name),
        "implementation_anchor": "scan_adk_zz500_cyb_spread_layer7_overheat.py",
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "\n".join(
            [
                'python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project "A-share / US momentum combo" --strategy "V7.7 ADK spread research" --subsystem "ZZ500/CYB spread Layer 8 entry staging" --parameter-group "first_entry_staging_close_proxy_after_l7_volhot" --repo . --entrypoint "scan_adk_zz500_cyb_spread_layer8_entry_staging.py" --date 2026-06-12 --slug "adk_zz500_cyb_spread_long_only_v77_adk_spread_layer8_entry_staging_close_proxy_after_l7_volhot"',
                'python -m py_compile "scan_adk_zz500_cyb_spread_layer8_entry_staging.py"',
                'git diff --check -- "scan_adk_zz500_cyb_spread_layer8_entry_staging.py"',
                'python "scan_adk_zz500_cyb_spread_layer8_entry_staging.py"',
