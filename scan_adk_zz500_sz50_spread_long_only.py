"""Layer 0/1 scan for ADK-style long ZZ500 / short SZ50 spread.

Direction: long CSI 500 price index (1.000905) / short SSE 50 price index
(1.000016). This first layer scans signal families only. Target-vol, NAV
...
RUN_DIR = ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_sz50_spread_long_only_v77_adk_spread_layer0_layer1_signal_family"
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/SZ50 ADK Spread Layer 0/1 Scan",
        "",
        "## Run Metadata",
        ...
        "",
        "## Research Question",
        "Fresh first-layer test of long ZZ500 / short SZ50 as a standalone ADK-style spread sleeve.",
        "",
        "## Implementation Anchor",
        "- V7.7 constants and local cache loader imported from `mnt_bot V 7.7 plus.py`.",
        "- Direction ratio: `1.000905 / 1.000016`.",
        ...
        "",
        "## Commands",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"ZZ500/SZ50 spread Layer 0/1\" --parameter-group \"signal_family_spread_signal_window_threshold\" --repo . --entrypoint \"scan_adk_zz500_sz50_spread_long_only.py\" --date 2026-06-12 --slug \"adk_zz500_sz50_spread_long_only_v77_adk_spread_layer0_layer1_signal_family\"`",
        "- `python -m py_compile \"scan_adk_zz500_sz50_spread_long_only.py\"`",
        "- `python \"scan_adk_zz500_sz50_spread_long_only.py\"`",
    ...
    meta = {
        ...
        "baseline": {"direction": "long_ZZ500_short_SZ50", "threshold": 0.0},
        "candidate_grid": grid,
        "cost_model": {
