"""Layer 2 score and absolute-bias filter scan for long SZ50 / short ZZ500.

Inputs are the Layer 1 width-supported carry candidates. This layer scans score
thresholds and an absolute SZ50/ZZ500 ratio-bias gate only. Target-vol, NAV
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_sz50_zz500_spread_long_only_v77_adk_spread_layer2_score_abs_filter_l1_width_anchors"

ANCHORS = [
    {
        "anchor": "bias_65_18_we2p75",
        "family": "bias_momentum",
        "bias_ma": 65,
        "mom_day": 18,
        "weight_end": 2.75,
        "layer1_candidate": "dense_bias_ma065_mom018_we2p75_gt0",
    },
    {
        "anchor": "bias_60_16_we2p75",
        "family": "bias_momentum",
        "bias_ma": 60,
        "mom_day": 16,
        "weight_end": 2.75,
        "layer1_candidate": "dense_bias_ma060_mom016_we2p75_gt0",
    },
    {
        "anchor": "bias_65_16_we2p75",
        "family": "bias_momentum",
        "bias_ma": 65,
        "mom_day": 16,
        "weight_end": 2.75,
        "layer1_candidate": "dense_bias_ma065_mom016_we2p75_gt0",
    },
    {
        "anchor": "bias_65_18_we2p5",
        "family": "bias_momentum",
        "bias_ma": 65,
        "mom_day": 18,
        "weight_end": 2.5,
        "layer1_candidate": "dense_bias_ma065_mom018_we2p5_gt0",
    },
    {
        "anchor": "bias_60_18_we2p75_return_heavy",
        "family": "bias_momentum",
        "bias_ma": 60,
        "mom_day": 18,
        "weight_end": 2.75,
...
SCORE_THRESHOLDS = [-3.0, -2.0, -1.0, 0.0, 0.5, 1.0, 1.5, 2.0, 3.0, 4.0, 5.0]
...
def select_carry(window_metrics: pd.DataFrame, ridge: pd.DataFrame) -> pd.DataFrame:
    ...
    if patch.empty:
        ...
        keys = patch.head(14)[["loss_tier_pp", "anchor", "score_threshold"]].drop_duplicates()
        pool_parts = []
...
def main() -> None:
    ...
    record_lines = [
        "# SZ50/ZZ500 Layer 2 Score And Absolute-Bias Filter Scan",
        "",
        "## Run Metadata",
        ...
        "",
        "## Research Question",
        "Scan score thresholds and absolute ratio-bias filters against Layer 1 width-supported anchors for long SZ50 / short ZZ500.",
        "",
        "## Layer Inputs",
        "- Anchors:",
        *[
            f"  - `{anchor['anchor']}` from `{anchor['layer1_candidate']}`: bias_ma={anchor['bias_ma']}, mom_day={anchor['mom_day']}, weight_end={anchor['weight_end']}"
            for anchor in ANCHORS
        ],
        "- Score thresholds: `-3, -2, -1, 0, 0.5, 1, 1.5, 2, 3, 4, 5`.",
        "- Absolute-bias gate: `SZ50/ZZ500 ratio / MA(abs_ma) - 1 > abs_threshold`; abs_ma=20..80 step5; abs_threshold=-8%..8% step0.5%.",
        "",
        ...
        "",
        "## Commands",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"SZ50/ZZ500 spread Layer 2 score abs\" --parameter-group \"score_threshold_abs_bias_filter\" --repo . --entrypoint \"scan_adk_sz50_zz500_spread_layer2_score_abs_filter.py\" --date 2026-06-12 --slug \"adk_sz50_zz500_spread_long_only_v77_adk_spread_layer2_score_abs_filter_l1_width_anchors\"`",
        "- `python -m py_compile \"scan_adk_sz50_zz500_spread_layer2_score_abs_filter.py\"`",
        "- `python \"scan_adk_sz50_zz500_spread_layer2_score_abs_filter.py\"`",
    ...
    meta = {
        ...
        "subsystem": "SZ50/ZZ500 spread Layer 2 score abs",
