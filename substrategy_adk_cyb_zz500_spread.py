#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Standalone CYB/ZZ500 ADK spread substrategy.

This module exposes the finalized long-CYB / short-ZZ500 sleeve as an
importable sub-strategy while keeping exact parity with the fixed final runner.
"""
...
import final_adk_cyb_zz500_spread as final_strategy
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run finalized standalone CYB/ZZ500 ADK spread substrategy.",
    )
    parser.add_argument(
        "--profile",
        choices=sorted(final_strategy.PROFILES),
        default=DEFAULT_PROFILE,
        help="Final fixed profile to run; default is the primary_nav3 profile.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
