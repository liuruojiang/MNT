"""Layer 5 momentum-decay scan for long ZZ500 / short HS300 spread.
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_hs300_spread_long_only_v77_adk_spread_layer5_momentum_decay_l4_nav_off"
L4_RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_hs300_spread_long_only_v77_adk_spread_layer4_nav_defense_l3_carry"
_L4_DAILY_CACHE: pd.DataFrame | None = None

L4_INPUTS = [
    {
        **l4.L3_INPUTS[0],
        "layer4_anchor": "main_confirm_nav_off",
        "layer4_candidate": "l4_main_confirm_tv20_rv60_abs20_nav_off",
    },
    {
        **l4.L3_INPUTS[1],
        "layer4_anchor": "return_preserve_nav_off",
        "layer4_candidate": "l4_return_preserve_tv18_rv80_abs20_nav_off",
    },
    {
        **l4.L3_INPUTS[2],
        "layer4_anchor": "primary_dd_nav_off",
        "layer4_candidate": "l4_primary_tv8_rv120_abs15_nav_off",
    },
    {
        **l4.L3_INPUTS[3],
        "layer4_anchor": "ultra_def_nav_off",
        "layer4_candidate": "l4_ultra_def_confirm_tv6_rv120_abs20_nav_off",
    },
]
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/HS300 Layer 5 Momentum-Decay Scan",
        "",
        "## Run Metadata",
        f"- created_at: {datetime.now().isoformat(timespec='seconds')}",
        f"- run_folder: `{RUN_DIR}`",
        "- decision: `layer5_momentum_decay_complete_not_promoted`",
        "- stability: `momentum_decay_width_pending_user_confirmation`",
        "",
        "## Research Question",
        ...
        *[
        ...
        "- No NAV defense, overheat, amount, or volume overlay is applied in the promoted baseline.",
        "",
        "## Runtime Override Plan",
        "No production defaults changed. This is a research-only Layer 5 scan.",
        "",
        "## Commands",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"ZZ500/HS300 spread Layer 5 momentum decay\" --parameter-group \"score_peak_decay_recovery_derisk\" --repo . --entrypoint \"scan_adk_zz500_hs300_spread_layer5_momentum_decay.py\" --date 2026-06-12 --slug \"adk_zz500_hs300_spread_long_only_v77_adk_spread_layer5_momentum_decay_l4_nav_off\"`",
        "- `python -m py_compile \"scan_adk_zz500_hs300_spread_layer5_momentum_decay.py\"`",
        "- `python \"scan_adk_zz500_hs300_spread_layer5_momentum_decay.py\"`",
        "- `python D:/Codex/home/skills/quant-param-scan/scripts/finalize_quant_param_scan_run.py <run_folder> --decision \"layer5_momentum_decay_complete_not_promoted\" --stability-label \"momentum_decay_width_pending_user_confirmation\"`",
        ...
        "",
        "## Decision",
        "Layer 5 momentum-decay scan completed but not promoted. Stop for user review before any Layer 6 interaction check or later overlays.",
        "",
        "## User-Facing Summary",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/HS300 spread Layer 5 momentum decay",
        "repo_root": str(base.ROOT),
        "entrypoint": str(Path(__file__).name),
        "implementation_anchor": "scan_adk_zz500_hs300_spread_layer4_nav_defense.py",
        ...
        "decision": "layer5_momentum_decay_complete_not_promoted",
        "stability_label": "momentum_decay_width_pending_user_confirmation",
        "outputs": {
    ...
    (RUN_DIR / "command_log.txt").write_text(
        ...
        "python -m py_compile \"scan_adk_zz500_hs300_spread_layer5_momentum_decay.py\"\n"
        "python \"scan_adk_zz500_hs300_spread_layer5_momentum_decay.py\"\n"
        f"python D:/Codex/home/skills/quant-param-scan/scripts/finalize_quant_param_scan_run.py \"{RUN_DIR}\" --decision \"layer5_momentum_decay_complete_not_promoted\" --stability-label \"momentum_decay_width_pending_user_confirmation\"\n"
