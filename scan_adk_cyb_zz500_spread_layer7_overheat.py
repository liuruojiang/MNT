"""Layer 7 score/realized-vol overheat for long CYB / short ZZ500.

Layer 6 did not promote NAV+decay interaction, so this layer carries the
Layer 4 NAV-only lines and tests only score/realized-vol overheat overlays.
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_cyb_zz500_spread_long_only_v77_adk_spread_layer7_overheat_after_nav_only"

LINES = [
    {**l5.L4_INPUTS[0], "line": "return_nav3", "line_role": "return_watchlist"},
    {**l5.L4_INPUTS[1], "line": "primary_nav3", "line_role": "primary_strict_full_5y"},
    {**l5.L4_INPUTS[2], "line": "confirm_nav3", "line_role": "same_patch_confirmation"},
    {**l5.L4_INPUTS[3], "line": "defensive_nav4", "line_role": "defensive_watchlist"},
    {**l5.L4_INPUTS[4], "line": "defensive_nav3", "line_role": "defensive_watchlist"},
]

SCORE_HOT_THRESHOLDS = [3, 4, 5, 6, 8, 10, 12, 15, 18]
SCORE_HOT_SCALES = [0.0, 0.25, 0.5, 0.75]
VOL_HOT_WINDOWS = [20, 30, 40, 60, 90]
VOL_HOT_THRESHOLDS = [0.10, 0.12, 0.15, 0.18, 0.22, 0.26, 0.30, 0.35, 0.40]
...
def apply_overlay(base_frame: pd.DataFrame, kind: str, params: dict[str, float]) -> pd.DataFrame:
    ...
    final_weight = base_frame["base_weight"] * mult
...
def main() -> None:
    ...
    base_by_line = {str(line["line"]): l5.l4_base_frame(panel, line, scores, r2s, abs_bias) for line in LINES}
    ...
    stability = "scorehot_realized_volhot_after_nav_only_review"
    record_lines = [
        "# CYB/ZZ500 Layer 7 Overheat After NAV-Only",
        "",
        "## Run Metadata",
        ...
        "- Imports Layer 5 helper to reconstruct Layer 4 NAV-only baseline.",
    ...
    meta = {
        ...
        "subsystem": "CYB/ZZ500 spread Layer 7 overheat",
        ...
        "scan_type": "layer7_overheat_after_nav_only",
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project \"A-share / US momentum combo\" --strategy \"V7.7 ADK spread research\" --subsystem \"CYB/ZZ500 spread Layer 7 overheat\" --parameter-group \"scorehot_realized_volhot_after_nav_only\" --repo . --entrypoint \"scan_adk_cyb_zz500_spread_layer7_overheat.py\" --date 2026-06-12 --slug \"adk_cyb_zz500_spread_long_only_v77_adk_spread_layer7_overheat_after_nav_only\"\n"
        "python -m py_compile \"scan_adk_cyb_zz500_spread_layer7_overheat.py\"\n"
        "python \"scan_adk_cyb_zz500_spread_layer7_overheat.py\"\n"
