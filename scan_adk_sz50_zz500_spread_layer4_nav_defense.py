"""Layer 4 NAV drawdown defense after Layer 3 target-vol for SZ50/ZZ500.
...
RUN_DIR = base.ROOT / "quant_param_scan_runs" / "20260612_adk_sz50_zz500_spread_long_only_v77_adk_spread_layer4_nav_defense_after_l3_target_vol"
...
LINES = [
    ...
    {
        "line": "lowdd_65_16_tv6_vw20_max1p25_db0p25",
        "line_role": "low_drawdown_watch",
        "bias_ma": 65,
        "mom_day": 16,
        "weight_end": 2.75,
        "score_threshold": 1.0,
        ...
        "scale_deadband": 0.25,
        "tv_enabled": True,
        "layer3_candidate": "l3_confirm_65_16_s1_abs40_0_tv6_vw20_max1p25_db0p25",
    },
    {
        "line": "primary_65_16_tv8_vw20_max1p5_db0p30",
        "line_role": "primary_65_16_confirmation",
        "bias_ma": 65,
        "mom_day": 16,
        "weight_end": 2.75,
        "score_threshold": 1.0,
...
def main() -> None:
    ...
    record_lines = [
        "# SZ50/ZZ500 Layer 4 NAV Defense After Target-Vol",
        "",
        "## Run Metadata",
        ...
        "- Imports Layer 3 signal/target-vol functions from `scan_adk_sz50_zz500_spread_layer3_target_vol.py`.",
        ...
        "",
        "## Full-Sample Results",
        window_metrics[window_metrics["nav_enabled"] == False][display_cols].to_markdown(index=False),
        "",
        "## Window Results",
    ...
    meta = {
        ...
        "subsystem": "SZ50/ZZ500 spread Layer 4 NAV defense",
    ...
    (RUN_DIR / "command_log.txt").write_text(
        "\n".join(
            [
                'python D:/Codex/home/skills/quant-param-scan/scripts/init_quant_param_scan_run.py --root quant_param_scan_runs --project "A-share / US momentum combo" --strategy "V7.7 ADK spread research" --subsystem "SZ50/ZZ500 spread Layer 4 NAV defense" --parameter-group "nav_drawdown_threshold_defense_scale" --repo . --entrypoint "scan_adk_sz50_zz500_spread_layer4_nav_defense.py" --date 2026-06-12 --slug "adk_sz50_zz500_spread_long_only_v77_adk_spread_layer4_nav_defense_after_l3_target_vol"',
                'python -m py_compile "scan_adk_sz50_zz500_spread_layer4_nav_defense.py"',
                'python "scan_adk_sz50_zz500_spread_layer4_nav_defense.py"',
    ...
    print("BASELINES")
    print(window_metrics[window_metrics.nav_enabled == False][display_cols].to_string(index=False))
