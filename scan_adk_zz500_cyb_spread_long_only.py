"""Layer 0/1 scan for ADK-style long ZZ500 / short CYB spread.

Direction: long CSI 500 price index (1.000905) / short ChiNext price index
(0.399006). This first layer scans signal families only. Target-vol, NAV
...
RUN_DIR = ROOT / "quant_param_scan_runs" / "20260612_adk_zz500_cyb_spread_long_only_v77_adk_spread_layer0_layer1_signal_family"
...
def main() -> None:
    ...
    record_lines = [
        "# ZZ500/CYB ADK Spread Layer 0/1 Scan",
        "",
        "## Run Metadata",
        ...
        "",
        "## Research Question",
        "Fresh first-layer test of long ZZ500 / short CYB as a standalone ADK-style spread sleeve.",
        "",
        "## Implementation Anchor",
        "- V7.7 constants and local cache loader imported from `mnt_bot V 7.7 plus.py`.",
        "- Direction ratio: `1.000905 / 0.399006`.",
        ...
        "",
        "## Commands",
        "- `python -m py_compile \"scan_adk_zz500_cyb_spread_long_only.py\"`",
        "- `python \"scan_adk_zz500_cyb_spread_long_only.py\"`",
    ...
    meta = {
        ...
        "subsystem": "ZZ500/CYB spread Layer 0/1",
        "repo_root": str(ROOT),
        ...
        "baseline": {"direction": "long_ZZ500_short_CYB", "threshold": 0.0},
        "candidate_grid": grid,
        "cost_model": {
