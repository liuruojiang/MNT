...
|---|---|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---|
| Fixed default | BASELINE | 10% | 15% | 15% | 20% | 40% | none | 30.52% / -7.87% / 3.29 | 60.93% / -5.50% / 5.38 | n/a | 0 | 0.0 | Executable default benchmark. |
| Stacked Sub-A 5/8 weekly + Microcap 3/10 month-end | ACTIVE_DEFAULT | 15% | 15% | 15% | 20% | 35% | Sub-A,Microcap | 32.65% / -7.16% / 3.45 | 64.22% / -5.33% / 5.69 | 26.25% | 122 | 13.8 | Active stacked portfolio-level dynamic budget; fixed weights remain the benchmark and rollback line. |
| Sub-A 5/8 weekly advisory | REPORT_WATCH_ONLY | 15% | 15% | 15% | 20% | 35% | Sub-A | 31.83% / -7.10% / 3.37 | 63.27% / -5.10% / 5.62 | 15.48% | 68 | 7.7 | Former active component; superseded by the adopted stacked dynamic budget. |
| Microcap advisory | REPORT_WATCH_ONLY | 10% | 15% | 15% | 20% | 40% | Microcap | 31.33% / -7.92% / 3.37 | 61.86% / -5.73% / 5.44 | 9.32% | 58 | 6.2 | Positive return evidence but max drawdown worsens versus fixed default. |
