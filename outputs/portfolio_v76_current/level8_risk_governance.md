...
| full_window_evidence | ACTIVE_OK | annual 2.18%, maxDD 0.72%, sharpe 0.17 | all >= 0, annual/sharpe strictly > 0 | Full-window evidence must remain positive versus fixed. |
| latest_1y_evidence | ACTIVE_OK | annual 4.35%, maxDD 0.38%, sharpe 0.40 | all >= 0, annual/sharpe strictly > 0 | Recent-window evidence should remain positive; failure starts review before hard rollback. |
| execution_load | ACTIVE_OK | switches 123, turnover 13.9 | switches <= 140, turnover <= 15.0 | Execution load should stay near the accepted stacked-budget level. |
...
| relative_nav_drawdown | ACTIVE_OK | current -0.18%, worst -2.54% | > -5.00% | Active budget has not breached the relative drawdown review threshold. |
