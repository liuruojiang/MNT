...
- Latest active excess NAV vs fixed: 27.46%
- Active relative NAV drawdown from its own peak: -0.38%
...
| full_window_evidence | ACTIVE_OK | annual 2.22%, maxDD 0.75%, sharpe 0.18 | all >= 0, annual/sharpe strictly > 0 | Full-window evidence must remain positive versus fixed. |
| latest_1y_evidence | ACTIVE_OK | annual 3.90%, maxDD 0.14%, sharpe 0.38 | all >= 0, annual/sharpe strictly > 0 | Recent-window evidence should remain positive; failure starts review before hard rollback. |
| execution_load | ACTIVE_OK | switches 128, turnover 14.3 | switches <= 140, turnover <= 15.0 | Execution load should stay near the accepted stacked-budget level. |
...
| relative_nav_drawdown | ACTIVE_OK | current -0.38%, worst -3.37% | > -5.00% | Active budget has not breached the relative drawdown review threshold. |
