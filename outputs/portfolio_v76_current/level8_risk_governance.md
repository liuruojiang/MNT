...
- Latest active excess NAV vs fixed: 25.95%
...
| execution_load | ACTIVE_OK | switches 125, turnover 14.1 | switches <= 140, turnover <= 15.0 | Execution load should stay near the accepted stacked-budget level. |
...
| relative_nav_drawdown | ACTIVE_OK | current -0.37%, worst -3.37% | > -5.00% | Active budget has not breached the relative drawdown review threshold. |
