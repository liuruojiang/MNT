...
- Latest active excess NAV vs fixed: 26.29%
...
| relative_nav_drawdown | ACTIVE_OK | current -0.33%, worst -2.54% | > -5.00% | Active budget has not breached the relative drawdown review threshold. |
