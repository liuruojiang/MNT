...
- Latest active excess NAV vs fixed: 26.67%
- Active relative NAV drawdown from its own peak: 0.00%
...
| relative_nav_drawdown | ACTIVE_OK | current 0.00%, worst -2.54% | > -5.00% | Active budget has not breached the relative drawdown review threshold. |
